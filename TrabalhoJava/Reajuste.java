...
public class Reajuste extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Informe a taxa de reajuste:");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(19, 19, 19)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(taxa, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void continuarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_continuarButtonActionPerformed
        // TODO add your handling code here:
            ...
            if(taxa.getText() == null || taxa.getText().trim().equals(""))
            {
                Principal.cp.setReajustar(10);
            }else{
                Principal.cp.setReajustar(Double.parseDouble(taxa.getText()));
            }
